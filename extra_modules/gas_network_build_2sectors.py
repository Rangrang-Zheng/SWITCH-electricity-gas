...
def define_components(m):
    ...
    m.Gas_Cost_Components_Per_Period.append("GeneralGlFixedCosts")
    m.Gas_Cost_Components_Per_Period.append("DirectionalGlFixedCosts")
    ...
    m.Gas_Cost_Components_Per_Period.append("GasStorageFixedCosts")
